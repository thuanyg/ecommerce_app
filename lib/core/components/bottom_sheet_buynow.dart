...
class BottomSheetBuyNow extends StatefulWidget {
  const BottomSheetBuyNow({super.key, required this.onCheckOutBuyNow});

  final Function(int) onCheckOutBuyNow;

  @override
  State<BottomSheetBuyNow> createState() => _BottomSheetBuyNowState();
}

class _BottomSheetBuyNowState extends State<BottomSheetBuyNow> {
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                widget.onCheckOutBuyNow(selectedQuantity);
